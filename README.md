...
| `user_project_wrapper` | 2920 × 3520 µm (Caravel) | **0 KLayout total** (FEOL 0, BEOL 0 — full breakdown in [`docs/drc-waiver-summary.md`](docs/drc-waiver-summary.md)) | chip-top extraction artefact under investigation | **GDS complete** (180 MB, 9 macros: 7 logic + 2 SRAM banks) |
