...
#   output.bit       = build/vivado/top_edge_sensor_aws_f2_spliced.bit
#
# Prerequisites:
...
OUT_BIT="${2:-$REPO_ROOT/build/vivado/top_edge_sensor_aws_f2_spliced.bit}"

IN_BIT="$REPO_ROOT/build/vivado/top_edge_sensor_aws_f2.bit"
MMI_FILE="$REPO_ROOT/build/vivado/top_edge_sensor_aws_f2.mmi"
