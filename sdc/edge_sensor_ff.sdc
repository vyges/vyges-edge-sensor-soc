...
# ── Corner: ff (pvt=ff, T=-40°C, V=1.95V) ──
...
# ── Timing reports ──────────────────────────────────────────────────────
report_checks -path_delay min -format full_clock_expanded -nworst 20 > reports/edge_sensor_ff_hold.rpt
report_tns > reports/edge_sensor_ff_tns.rpt
