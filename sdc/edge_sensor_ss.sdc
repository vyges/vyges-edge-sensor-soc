...
# ── Corner: ss (pvt=ss, T=100°C, V=1.6V) ──
...
# ── Timing reports ──────────────────────────────────────────────────────
report_checks -path_delay max -format full_clock_expanded -nworst 20 > reports/edge_sensor_ss_setup.rpt
report_tns > reports/edge_sensor_ss_tns.rpt
