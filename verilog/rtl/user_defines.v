...
// Edge Sensor SoC GPIO configuration
// Pin 0 (GPIO 5): uart_rx  — input
// Pin 1 (GPIO 6): uart_tx  — output
// Pin 2 (GPIO 7): spi_sclk — output
// Pin 3 (GPIO 8): spi_cs_n — output
// Pin 4 (GPIO 9): spi_mosi — output
// Pin 5 (GPIO 10): spi_miso — input
// Pin 6 (GPIO 11): fft_done — output (debug)
